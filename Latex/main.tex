...
In this paper we build a model based on BiSeNet \cite{} with a Short-Term Dense Concatenate network (STDC network) \cite{} as Context Path, 
based on different STDC modules. Then we implement an adversarial domain adaptation mathod \cite{} to reduce the domain shift between GTA5
...
method, based on MobileNets \cite{}. 
